...
export class EducationService extends BaseService {
    ...
    async create(dto: CreateEducationDto): Promise<ResponseData> {
    ...
    async update(id: number, data: UpdateEducationDto): Promise<ResponseData> {
        ...
        const save = await this.educationRepository.save({ ...data, id: id })
